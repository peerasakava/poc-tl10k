...
def llm_think_and_explain_revenue(symbol: str, filepath: pathlib.Path) -> str:
    ...
    4. SUMMARIZE THE DETAIL OF REVENUE STREAM BY EACH SEGMENT, PRODUCT/SERVICE WITH CONSOLIDATED NUMBER
        ...
        4.2 JUST EXPLAIN THE NUMBER EXACTLY FROM SOURCE
    ...
    6. CREATE THE MARKDWON TABLE OF REVENUE BY SOURCE AND REVENUE BY GEOGRAPHY BASED ON THE ABOVE SUMMARY
        6.1 SUBTOTAL OF THE REVENUE BY SOURCE AND REVENUE BY GEOGRAPHY SHOULD NOT BE INCLUDED
        ...
        6.3 LAST ROW OF THE TABLE MUST BE THE TOTAL OF REVENUE
          6.3.1 IF THE TOTAL OF TABLE IS NOT MATCH THE TOTAL REVENUE OF LATEST YEAR, THAT MEANS THE DATA SOURCE IS NOT RELATED TO OVERALL REVENUE, SKIP IT.
    </instructions>
